...
import { addNgo } from '../../Actions/NgoActions';
  ...
  function AddNgo() {
    ...
    const navigate = useNavigate();
      const initialValues = {ngoId: 100, ngoName : "", ngoLocation : "", ngoType: "", ngoMotive: "", donation: "",ngoActivities:""}
      ...
      const handleChange = (e)=>{
        ...
        if(e.name === "donation" || e.name === "ngoSize")
    ...
    return ( 
        ...
        <header className='back'>
          <h1 className='heading'>New NGO Form :</h1></header>
